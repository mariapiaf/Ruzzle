...
public class Model {
	...
	public List<Pos> trovaParola(String parola) {
		for(Pos p: board.getPositions()) { // cerco la prima lettera della parola nella griflia
	...
	private boolean cerca(String parola, int livello, List<Pos> percorso) {
		...
		// prendo l'ultima lettera inserita e controllo tutte le 
		// lettere adiacenti, cercando quella che potrebbe continuare la mia parola
